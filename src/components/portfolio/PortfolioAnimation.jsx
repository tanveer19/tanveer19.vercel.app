...
const portfolioItems = [
  ...
  {
    img: "/img/portfolio/money.jpg",
    width: 400,
    height: 400,
    title: "Send Money",
    subTitle: "Money",
    alterText: "send money",
    delayAnimation: "200",
    portfolioLink: "https://l2-b5-assignment-6-front.vercel.app",
    githubClientLink: "https://github.com/tanveer19/L2-B5-Assignment-6-Front",
    githubServerLink: "https://github.com/tanveer19/L2-B5-Assignment-6-Back",
    category: ["React"],
  },
  // {
...
const PortfolioAnimation = () => {
  return (
    <div className="portfolio-filter-01">
      <Tabs>
        <TabList className="filter flex justify-center flex-wrap">
          {tabList.map((val, i) => (
            <Tab key={i}>{val}</Tab>
          ))}
        </TabList>
